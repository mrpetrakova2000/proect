			  ...
			  <div class="row no-gutters">
				...
				<div>
				  <div class="card-body">
					...
					<button type="button" class="btn btn-link" onclick='dlt_item(event)' data-id='<?= $film['film_id'] ?>'> Удалить из избранного </button>
				  </div>
				</div>
			  </div>
			</div>
...
<script>
	function dlt_item(e) {
		if (confirm('Вы действительно хотите удалить фильм из избранного?')) {
			...
			window.location = '<?php echo ROOT; ?>favorites/notFav/' + film_id;
		} else {
			return false;
		}
	}
